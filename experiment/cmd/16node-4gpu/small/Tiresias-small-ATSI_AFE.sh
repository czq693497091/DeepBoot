...
exp_name=$policy-"$workload_scale"-AISS_AFE
...
nohup python3 simulator.py --policy $policy --workload $workloads --AFE $AFE --AISS $AISS \
--log_file $log_file --output $output --min-nodes $num_nodes --num-gpus $num_gpus > ./logs/$exp_name.log 2>&1 &